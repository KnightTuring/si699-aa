...
class GranularDataProcessor:
    ...
    def serve_granular_data(self, tract_num):
        print(f"Fetching data for tract {tract_num}")
        df = pd.read_csv("/Users/knightturing/UMich/Sem5_Winter2023/SI699_project/codebase/si699-aa/resources/yelp_data_enriched.csv")
        df[df['census_tract_fips'] == tract_num]
